...
export interface Agent {
     ...
     * This method is only available if the agent advertises the `sessionCapabilities.delete` capability.
     */
    deleteSession?(params: schema.DeleteSessionRequest): Promise<schema.DeleteSessionResponse | void>;
    /**
     * Resumes an existing session without returning previous messages.
     *
     * This method is only available if the agent advertises the `session.resume` capability.
     ...
     * @experimental
     */
    unstable_setProvider?(params: schema.SetProviderRequest): Promise<schema.SetProviderResponse | void>;
    /**
     * **UNSTABLE**
     *
     * This capability is not part of the spec yet, and may be removed or changed at any point.
     ...
     * @experimental
     */
    unstable_disableProvider?(params: schema.DisableProviderRequest): Promise<schema.DisableProviderResponse | void>;
    /**
     * Logout of the current authentication method.
     */
